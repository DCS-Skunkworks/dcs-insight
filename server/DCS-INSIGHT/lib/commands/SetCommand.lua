...
--- @class SetCommand : APIHandlerBase
...
function SetCommand:new()
    ...
    apiInfo.api_syntax = "GetDevice(device_id):SetCommand(command_id, new_value)"
...
function SetCommand:execute(api)
    ...
    if(param0 == nil or param1 == nil or param2 == nil) then 
        ...
        api.result = GetDevice(param0):SetCommand(param1, param2)        
