...
--- @class LoGetPilotNameAPI : APIHandlerBase
--- @field id number API ID
--- @field apiInfo APIInfo
local LoGetPilotNameAPI = {}


--- @func Returns new LoGetPilotNameAPI
function LoGetPilotNameAPI:new()
    local apiInfo = APIInfo:new()
    apiInfo.id = API_ID
    apiInfo.returns_data = true
    apiInfo.api_syntax = "LoGetPilotName()"
    apiInfo.parameter_count = 0
    apiInfo.parameter_defs = {}


    --- @type LoGetPilotNameAPI
    local o = {
        id = API_ID,
        apiInfo = apiInfo
    }
