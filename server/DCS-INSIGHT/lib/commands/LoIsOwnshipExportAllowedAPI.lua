...
--- @class LoIsOwnshipExportAllowedAPI : APIHandlerBase
--- @field id number API ID
--- @field apiInfo APIInfo
local LoIsOwnshipExportAllowedAPI = {}


--- @func Returns new LoIsOwnshipExportAllowedAPI
function LoIsOwnshipExportAllowedAPI:new()
    local apiInfo = APIInfo:new()
    apiInfo.id = API_ID
    apiInfo.returns_data = true
    apiInfo.api_syntax = "LoIsOwnshipExportAllowed()"
    apiInfo.parameter_count = 0
    apiInfo.parameter_defs = {}


    --- @type LoIsOwnshipExportAllowedAPI
    local o = {
        id = API_ID,
        apiInfo = apiInfo
    }
...
function LoIsOwnshipExportAllowedAPI:init()
end
...
function LoIsOwnshipExportAllowedAPI:execute(api)
    ...
    api.result = LoIsOwnshipExportAllowed()
