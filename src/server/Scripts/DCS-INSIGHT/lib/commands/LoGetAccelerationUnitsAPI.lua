module("LoGetAccelerationUnitsInsightAPI", package.seeall)
...
--- Returns new LoGetAccelerationUnitsAPI
--- @param o table|nil Parent
--- @param apiId integer API ID, must be unique
--- @return APIBase
function LoGetAccelerationUnitsAPI:new(o, apiId)
	o = o or APIBase:new(o, apiId, true, "LoGetAccelerationUnits()", 0)
...
function LoGetAccelerationUnitsAPI:init() end
